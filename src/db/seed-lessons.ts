/**
 * Lesson seed data for MarketDojo
 *
 * This file contains the initial lesson content that will be seeded into the database.
 * Each lesson includes educational content about trading and technical analysis.
 */
...
export const lessonSeeds: LessonSeed[] = [
  {
    ...
    difficulty: 1,
    imageUrl: null,
    content: `# Understanding Candlesticks
...
Understanding candlestick anatomy is your first step toward reading market sentiment and identifying trading opportunities.`,
  },
  {
    id: "lesson-002",
    slug: "bullish-vs-bearish",
...
Mastering the basics of bullish and bearish candles sets the foundation for recognizing more complex patterns.`,
  },
  {
    id: "lesson-003",
    slug: "doji-patterns",
    ...
    difficulty: 2,
    imageUrl: null,
    content: `# Doji Patterns: Signals of Indecision
...
Dojis are powerful when used correctly, but they require patience and confirmation. Master this pattern and you'll have a valuable tool in your trading arsenal.`,
  },
  {
    id: "lesson-004",
    slug: "hammer-hanging-man",
    title: "Hammer & Hanging Man",
    category: "patterns",
    order: 4,
    difficulty: 2,
    imageUrl: null,
    content: `# Hammer & Hanging Man Patterns
...
Master these patterns and you'll have powerful tools for spotting potential reversals. Remember: context is everything, and confirmation is mandatory!`,
  },
  {
    id: "lesson-005",
    ...
    difficulty: 3,
    imageUrl: null,
    content: `# Engulfing Patterns: Powerful Reversal Signals
...
Engulfing patterns are powerful, reliable signals when used in the right context. Master them, and you'll spot many high-probability trading opportunities!`,
  },
  {
    id: "lesson-006",
    ...
    difficulty: 3,
    imageUrl: null,
    content: `# Morning Star & Evening Star: Three-Candle Reversals
...
Morning Stars and Evening Stars are some of the most powerful reversal patterns you can find. When they appear in the right context with proper confirmation, they offer excellent risk-reward opportunities. Master these patterns, and you'll catch significant reversals!`,
  },
];
